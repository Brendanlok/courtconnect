...
import { Home, CalendarDays, Trophy, Users, Zap, MessageCircle } from 'lucide-react';
...
export function BottomNav() {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-slate-900/95 backdrop-blur border-t border-slate-800 grid grid-cols-6">
