...
import { Bell, X, Swords, Users, Shield, CheckCircle, MessageCircle, UserPlus, UserCheck, Calendar, Trophy, Award, Clock, TrendingUp } from 'lucide-react';
...
export const NOTIF_ICON: Record<Notification['type'], React.ReactNode> = {
  ...
  match_reminder:          <Clock size={14} className="text-emerald-400"/>,
...
export function NotificationPanel({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div ref={ref} role="dialog" aria-label="Notifications" className="popover-anim origin-top-right absolute right-0 top-full mt-2 w-80 bg-slate-900 border border-slate-700 rounded-2xl shadow-2xl shadow-black/50 z-50 overflow-hidden">
