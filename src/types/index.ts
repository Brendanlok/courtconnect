...
export interface Notification {
  id: string;
  type: 'challenge_received' | 'challenge_accepted' | 'challenge_declined' | 'partner_request' | 'club_request' | 'club_join_request' | 'club_accepted' | 'club_declined' | 'club_message' | 'match_pending' | 'match_invite' | 'match_confirmed' | 'match_disputed' | 'new_message' | 'friend_request' | 'friend_accepted' | 'event_invite' | 'event_registered' | 'badge_earned' | 'tournament_request' | 'tournament_join_request' | 'tournament_accepted' | 'tournament_declined' | 'tournament_win' | 'tournament_cancelled' | 'inactivity_reminder' | 'weekly_digest' | 'referral_joined' | 'match_reminder';
  title: string;
  body: string;
  read: boolean;
  createdAt: string;
